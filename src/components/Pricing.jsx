    ...
    return <section id='pricing' className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                ...
                <p className='text-gray-400 text-base text-xl sm:text-lg max-w-2xl mx-auto'>Choose the perfect plan for your needs. All plans include 14-day free trial</p>
            </div>

            <div className='grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8  lg:gap-6'>
                {plans.map((plan, key) => (
                    <div key={key} className={`relative bg-slate-900/50 backdrop-blur-sm border round-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible flex flex-col h-full 
                        ${plan.mostPopular
                        ...
                        <div className='text-center mb-6 sm:mb-8'>
                            ...
                            <p className='text-gray-400 text-xs sm:text-xs mb-3 sm:mb-4'>{plan.description}</p>
                        ...
                        <ul className='space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row'>
                            {plan.features.map((feature, featureKey) => (
                                <li key={featureKey} className='flex items-start space-x-2 sm:space-x-3'>
                                    <div className='flex-shrink-0 w-4 h-4 sm:w-5 h-5 rounded-full bg-blue-500/20 flex items-center justify-center mt-0.5'>
